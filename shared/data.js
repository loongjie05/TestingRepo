...
(function(){
    ...
    (function ensureMinimumCounts(){
        ...
        const europeExtras = [
            { title: "Fish and Chips", country: "United Kingdom", continent: "Europe", type: "Snack", price: "£6 - £12", description: "Battered fried fish with chips.", ingredients: "Fish • Potato • Batter", score: 8.7, images: { cover: "../LJ/pictures/Fries.png" } },
            { title: "Paella", country: "Spain", continent: "Europe", type: "Rice", price: "€10 - €20", description: "Saffron rice with seafood or meat.", ingredients: "Rice • Saffron • Seafood • Chicken", score: 8.9, images: { cover: placeholderImg } },
            { title: "Pizza Margherita", country: "Italy", continent: "Europe", type: "Bread", price: "€6 - €12", description: "Tomato, mozzarella, and basil pizza.", ingredients: "Flour • Tomato • Mozzarella • Basil", score: 9.1, images: { cover: placeholderImg } },
            { title: "Gyro", country: "Greece", continent: "Europe", type: "Meat", price: "€3 - €6", description: "Spit-roasted meat in pita with tzatziki.", ingredients: "Pita • Pork/Chicken • Tzatziki", score: 8.6, images: { cover: placeholderImg } },
            { title: "Pierogi", country: "Poland", continent: "Europe", type: "Dumpling", price: "zł8 - zł20", description: "Stuffed dumplings boiled or fried.", ingredients: "Flour • Potato • Cheese", score: 8.5, images: { cover: placeholderImg } },
            { title: "Goulash", country: "Hungary", continent: "Europe", type: "Stew", price: "€6 - €12", description: "Beef stew with paprika.", ingredients: "Beef • Paprika • Onion", score: 8.6, images: { cover: placeholderImg } },
            { title: "Bratwurst", country: "Germany", continent: "Europe", type: "Sausage", price: "€3 - €6", description: "Grilled sausage served in a roll.", ingredients: "Pork • Spices • Bun", score: 8.4, images: { cover: placeholderImg } },
            { title: "Crêpes", country: "France", continent: "Europe", type: "Pastry", price: "€3 - €8", description: "Thin pancakes with various fillings.", ingredients: "Flour • Egg • Milk", score: 8.5, images: { cover: "../LJ/pictures/Pancake.png" } },
            { title: "Doner Kebab", country: "Turkey", continent: "Europe", type: "Meat", price: "€4 - €7", description: "Vertically roasted meat in flatbread.", ingredients: "Lamb/Chicken • Flatbread • Salad", score: 8.8, images: { cover: placeholderImg } }
        ];

        const naExtras = [
            { title: "Hamburger", country: "United States", continent: "North America", type: "Sandwich", price: "$4 - $12", description: "Beef patty in a bun with toppings.", ingredients: "Beef • Bun • Lettuce • Tomato", score: 8.8, images: { cover: "../LJ/pictures/Burger.png" } },
            { title: "Hot Dog", country: "United States", continent: "North America", type: "Snack", price: "$2 - $6", description: "Sausage in a sliced bun.", ingredients: "Sausage • Bun • Mustard", score: 8.2, images: { cover: placeholderImg } },
            { title: "Burrito", country: "Mexico", continent: "North America", type: "Wrap", price: "$5 - $10", description: "Flour tortilla wrapped around fillings.", ingredients: "Tortilla • Beans • Rice • Meat", score: 8.6, images: { cover: placeholderImg } },
            { title: "Nachos", country: "Mexico", continent: "North America", type: "Snack", price: "$4 - $9", description: "Corn chips with cheese and toppings.", ingredients: "Corn chips • Cheese • Jalapeños", score: 8.0, images: { cover: placeholderImg } },
            { title: "Clam Chowder", country: "United States", continent: "North America", type: "Soup", price: "$6 - $12", description: "Creamy soup with clams and potatoes.", ingredients: "Clams • Potato • Cream", score: 8.4, images: { cover: placeholderImg } },
            { title: "Gumbo", country: "United States", continent: "North America", type: "Stew", price: "$8 - $14", description: "Louisiana stew with roux.", ingredients: "Roux • Okra • Sausage • Shrimp", score: 8.5, images: { cover: placeholderImg } },
            { title: "Buffalo Wings", country: "United States", continent: "North America", type: "Snack", price: "$6 - $12", description: "Deep-fried wings in hot sauce.", ingredients: "Chicken wings • Hot sauce • Butter", score: 8.6, images: { cover: placeholderImg } },
            { title: "Bagel with Lox", country: "United States", continent: "North America", type: "Bread", price: "$4 - $10", description: "Bagel with cream cheese and smoked salmon.", ingredients: "Bagel • Cream cheese • Salmon", score: 8.3, images: { cover: placeholderImg } },
            { title: "Philly Cheesesteak", country: "United States", continent: "North America", type: "Sandwich", price: "$7 - $12", description: "Beef and cheese in a hoagie roll.", ingredients: "Beef • Cheese • Roll", score: 8.5, images: { cover: placeholderImg } }
        ];
